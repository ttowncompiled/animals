...
var SightGameComponent = (function () {
    function SightGameComponent(firebase) {
        var _this = this;
    ...
    SightGameComponent.prototype.capitalize = function (name) {
        return lib_1.capitalize(name);
    };
    SightGameComponent.prototype.hasQuestions = function () {
        return this.questions.length > 0;
    };
    SightGameComponent.prototype.nextQuestion = function () {
    ...
    SightGameComponent.prototype.onSubmit = function (value) {
    ...
    SightGameComponent.CHILD = 'sight';
    SightGameComponent = __decorate([
    ...
    return SightGameComponent;
})();
exports.SightGameComponent = SightGameComponent;
